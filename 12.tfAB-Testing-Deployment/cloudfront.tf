locals {
  s3_origin_id         = "access-identity-s3_pro_20230208"
  s3_origin_staging_id = "access-identity-s3_pre_pro_20230208"
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  origin {
    domain_name = aws_s3_bucket.s3_pro_20230208.bucket_regional_domain_name
  ...
  origin {
    domain_name = aws_s3_bucket.s3_pre_pro_20230208.bucket_regional_domain_name
